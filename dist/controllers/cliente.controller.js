...
const cliente_rdn_1 = require("../reglasDeNegocio/cliente.rdn");
const cliente_dto_1 = require("../dtos/cliente.dto");
class ClientesController {
    constructor() {
        this.agregarAsync = async (req, res) => {
            //console.log(req.body)
            const usuario = new cliente_dto_1.ClienteDtoIn(req.body);
        ...
        this.usuarioRdn = new cliente_rdn_1.ClienteRdn();
    }
}
